...
# Window Icon Photo
icon = PhotoImage(file='imagen\\pic-icon.png')
...
# ===== Email icon =========
email_icon = Image.open('imagen\\email-icon.png')
...
# ===== password icon =========
password_icon = Image.open('imagen\\pass-icon.png')
...
# ===== picture icon =========
picture_icon = Image.open('imagen\\pic-icon.png')
...
# ===== Left Side Picture ============
side_image = Image.open('images\\icon.png')
# Define the desired width and height
desired_width = 50
desired_height = 50

# Resize the image
resized_image = side_image.resize((desired_width, desired_height))
...
def top():
    window.withdraw()
    subprocess.Popen(["python", "ProductManager.py"])
    window.destroy()
...
confirmPassword_icon = Image.open('imagen\\pass-icon.png')
...
# ===== Left Side Picture ============
side_image = Image.open('imagen\\vector.png')
photo = ImageTk.PhotoImage(side_image)
